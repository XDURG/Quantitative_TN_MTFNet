...
class SimpleMobileViT(nn.Module):
    def __init__(self, num_classes=1000):
        ...
        self.mobilevit = MobileViT(image_size=(256, 256), dims=[96, 120, 144], channels=[16, 32, 64, 64, 96, 96, 128, 128, 160, 160, 640], num_classes=num_classes)
...
class MultiFeatureNetwork(nn.Module):
    def __init__(self):
        ...
        self.composition_net = SimpleMobileViT()
        self.echogenic_foci_net = SimpleMobileViT()
        self.echogenicity_net = SiameseNetwork()
        self.margin_net = SimpleMobileViT()
...
model.load_state_dict(torch.load("./model_weights/mvit_78.pth"))
model.eval()
